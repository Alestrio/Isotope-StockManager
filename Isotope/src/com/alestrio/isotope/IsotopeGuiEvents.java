...
public class IsotopeGuiEvents {
	...
	@FXML
	private TextField txtRemainingLengthR;
	@FXML
	private TextField txtWidthR;
	@FXML
	private TextField txtRemainingWidthR;
	@FXML
	private TextField txtThicknessR;
	@FXML
	private TextField txtRemainingThicknessR;
	@FXML
	private TextField txtColorR;
	@FXML
	private TextField txtQtyR;
	@FXML
	...
	void clickAddBtnScrew () {
		Screw v = new Screw(Integer.parseInt(txtDiameterS.getText()) ,
				Integer.parseInt(txtLengthS.getText()) ,
				txtHeadS.getText() ,
				txtTypeS.getText() ,
				txtColorS.getText() ,
